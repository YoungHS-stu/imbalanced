...
def resample_and_train(train_df_X, train_df_y, resampler, trainer, q, share_dic):
    print(share_dic["train_X"])
            ...
            for preprocess_procedures in schema['preprocess_loop']:
                ...
                with mp.Manager() as manager:
                    ...
                    for resampler, trainer in combinations:
                        p = mp.Process(target=resample_and_train, args=(train_df_X, train_df_y, resampler, trainer, q, share_dic))
                        p.start()
                ...
                # start_time = time.time()
                # for resampler, trainer in combinations:
                #     resample_and_train(train_df_X, train_df_y, resampler, trainer)
                # 
                # end_time = time.time()
